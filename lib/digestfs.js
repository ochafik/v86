 ...
 */
function DigestFS(storage, qidcounter) {
    /** @type {Array.<!Inode>} */
    this.inodes = [];
    this.events = [];
...
DigestFS.prototype.get_state = function()
{
    let state = [];
...
DigestFS.prototype.set_state = function(state)
{
...
DigestFS.prototype.AddEvent = function(id, OnEvent) {
...
/** @private */
DigestFS.prototype.HandleEvent = function(id) {
...
DigestFS.prototype.load_from_json = function(fs, done)
{
...
/** @private */
DigestFS.prototype.LoadRecursive = function(data, parentid)
{
...
DigestFS.prototype.LoadDir = function(parentid, children)
{
 ...
 * @return {boolean}
 */
DigestFS.prototype.should_be_linked = function(inode)
{
 ...
 * @param {string} name
 */
DigestFS.prototype.link_under_dir = function(parentid, idx, name)
{
 ...
 * @param {string} name
 */
DigestFS.prototype.unlink_from_dir = function(parentid, name)
{
...
/** @private */
DigestFS.prototype.PushInode = function(inode, parentid, name) {
    if (parentid != -1) {
 ...
 */
DigestFS.prototype.divert = function(parentid, filename)
{
 ...
 */
DigestFS.prototype.copy_inode = function(src_inode, dest_inode)
{
...
/** @private */
DigestFS.prototype.CreateInode = function() {
...
DigestFS.prototype.CreateDirectory = function(name, parentid) {
    const parent_inode = this.inodes[parentid];
...
DigestFS.prototype.CreateFile = function(filename, parentid) {
    const parent_inode = this.inodes[parentid];
...
DigestFS.prototype.CreateNode = function(filename, parentid, major, minor) {
    const parent_inode = this.inodes[parentid];
    if(this.is_forwarder(parent_inode))
    {
        const foreign_parentid = parent_inode.foreign_id;
...
DigestFS.prototype.CreateSymlink = function(filename, parentid, symlink) {
    const parent_inode = this.inodes[parentid];
    if(this.is_forwarder(parent_inode))
    {
        const foreign_parentid = parent_inode.foreign_id;
...
DigestFS.prototype.CreateTextFile = async function(filename, parentid, str) {
    const parent_inode = this.inodes[parentid];
    if(this.is_forwarder(parent_inode))
    {
        const foreign_parentid = parent_inode.foreign_id;
 ...
 */
DigestFS.prototype.CreateBinaryFile = async function(filename, parentid, buffer) {
    const parent_inode = this.inodes[parentid];
    if(this.is_forwarder(parent_inode))
    {
        const foreign_parentid = parent_inode.foreign_id;
...
DigestFS.prototype.OpenInode = function(id, mode) {
    var inode = this.inodes[id];
    if(this.is_forwarder(inode))
    {
...
DigestFS.prototype.CloseInode = async function(id) {
...
DigestFS.prototype.Rename = async function(olddirid, oldname, newdirid, newname) {
...
DigestFS.prototype.Write = async function(id, offset, count, buffer) {
...
DigestFS.prototype.Read = async function(inodeid, offset, count)
{
...
DigestFS.prototype.Search = function(parentid, name) {
    const parent_inode = this.inodes[parentid];
...
DigestFS.prototype.CountUsedInodes = function()
{
...
DigestFS.prototype.CountFreeInodes = function()
{
    let count = 1024 * 1024;
...
DigestFS.prototype.GetTotalSize = function() {
...
DigestFS.prototype.GetSpace = function() {
 ...
 * @return {string}
 */
DigestFS.prototype.GetDirectoryName = function(idx)
{
...
/** @private */
DigestFS.prototype.GetFullPath = function(idx) {
 ...
 */
DigestFS.prototype.Link = function(parentid, targetid, name)
{
...
DigestFS.prototype.Unlink = function(parentid, name) {
    if(name === "." || name === "..")
    {
...
/** @private */
DigestFS.prototype.DeleteData = async function(idx)
{
    const inode = this.inodes[idx];
    if(this.is_forwarder(inode))
    {
 ...
 */
DigestFS.prototype.get_buffer = async function(idx)
{
    const inode = this.inodes[idx];
 ...
 */
DigestFS.prototype.get_data = async function(idx, offset, count)
{
    const inode = this.inodes[idx];
 ...
 * @param {Uint8Array} buffer
 */
DigestFS.prototype.set_data = async function(idx, buffer)
{
 ...
 * @return {!Inode}
 */
DigestFS.prototype.GetInode = function(idx)
{
...
DigestFS.prototype.ChangeSize = async function(idx, newsize)
{
...
DigestFS.prototype.SearchPath = function(path) {
    //path = path.replace(/\/\//g, "/");
    path = path.replace("//", "/");
    var walk = path.split("/");
 ...
 */
DigestFS.prototype.GetRecursiveList = function(dirid, list) {
...
DigestFS.prototype.RecursiveDelete = function(path) {
    var toDelete = [];
...
DigestFS.prototype.DeleteNode = function(path) {
    var ids = this.SearchPath(path);
    if (ids.id == -1) return;
...
/** @param {*=} info */
DigestFS.prototype.NotifyListeners = function(id, action, info) {
    //if(info==undefined)
    //    info = {};
...
DigestFS.prototype.Check = function() {
...
/** @private */
DigestFS.prototype.FillDirectory = function(dirid) {
    ...
    this.inodedata[dirid] = inode.getDirectoryData(this);
};

DigestFS.prototype.RoundToDirentry = function(dirid, offset_target)
{
 ...
 * @return {boolean}
 */
DigestFS.prototype.IsDirectory = function(idx)
{
    const inode = this.inodes[idx];
    if(this.is_forwarder(inode))
    {
 ...
 * @return {boolean}
 */
DigestFS.prototype.IsEmpty = function(idx)
{
    const inode = this.inodes[idx];
    if(this.is_forwarder(inode))
    {
...
DigestFS.prototype.GetChildren = function(idx)
{
 ...
 */
DigestFS.prototype.GetParent = function(idx)
{
...
DigestFS.prototype.PrepareCAPs = function(id) {
 ...
 */
DigestFS.prototype.set_forwarder = function(idx, mount_id, foreign_id)
{
    const inode = this.inodes[idx];
 ...
 */
DigestFS.prototype.create_forwarder = function(mount_id, foreign_id)
{
 ...
 * @return {boolean}
 */
DigestFS.prototype.is_forwarder = function(inode)
{
 ...
 * @return {boolean}
 */
DigestFS.prototype.is_a_root = function(idx)
{
 ...
 */
DigestFS.prototype.get_forwarder = function(mount_id, foreign_id)
{
 ...
 * @param {Inode} inode
 */
DigestFS.prototype.delete_forwarder = function(inode)
{
 ...
 * @return {FS}
 */
DigestFS.prototype.follow_fs = function(inode)
{
 ...
 */
DigestFS.prototype.Mount = function(path, fs)
{
 ...
 * @return {!FSLockRegion}
 */
DigestFS.prototype.DescribeLock = function(type, start, length, proc_id, client_id)
{
 ...
 */
DigestFS.prototype.GetLock = function(id, request)
{
    const inode = this.inodes[id];
 ...
 */
DigestFS.prototype.Lock = function(id, request, flags)
{
    const inode = this.inodes[id];
...
DigestFS.prototype.read_dir = function(path)
{
...
DigestFS.prototype.read_file = function(file)
{
